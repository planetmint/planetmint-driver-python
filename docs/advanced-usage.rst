...
.. todo:: This is work in progress. More examples will gradually appear as issues like
    ...
    * https://github.com/planetmint/planetmint-driver/issues/110
...
seconds. When timeout expires, an instance of ``planetmint_driver.exceptions.TimeoutError`` is raised. Specify
...
.. danger:: We are currently working to support partial fulfillments, such that
    ...
    `planetmint/planetmint/issues/729 <https://github.com/planetmint/planetmint/issues/729>`_
...
.. ipython::
    ...
    In [0]: from planetmint_driver.exceptions import MissingPrivateKeyError
...
`Python <https://github.com/planetmint/cryptoconditions>`_,
...
2. Set up the threshold condition using the
   `cryptocondition library <https://github.com/planetmint/cryptoconditions>`_
...
.. todo:: Stay tuned. Will soon be documented once
    ...
    * https://github.com/planetmint/planetmint-driver/issues/109
...
..     # todo: Needs https://github.com/planetmint/planetmint-driver/issues/109
..
...
..
..     # Check if the transaction is already in the planetmint
...
.. todo:: Stay tuned. Will soon be documented once
    ...
    * https://github.com/planetmint/planetmint-driver/issues/108
    * https://github.com/planetmint/planetmint-driver/issues/110
...
Of course, when the ``execute`` transaction was accepted in-time by planetmint,
